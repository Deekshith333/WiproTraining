...
#PartialLink
image_link = driver.find_element(By.PARTIAL_LINK_TEXT, "Ima")
image_link.click()
time.sleep(10)
...
or_example = driver.find_element(By.XPATH, "//td[text()='Tim' and text()='Frank']")
...
# Desendant - find all descendants (cells) under table body
descendants = driver.find_elements(By.XPATH, "//table[@id='table1']/descendant::td")
print(f"Descendant Example -> Found {len(descendants)} descendant cell.")
...
# toLeftOf _> element to the right of another
